...
class EntryGUI:
    ...
    def show_all_definitions(self):
        ...
        label = Label(new_window, text="Possible definitions:", bg='white', font=('Helvetica', 15, 'bold'))
        label.grid(row=0, column=0, sticky='nswe')
        textbox = Text(new_window, bg='white', fg='black', font=('Helvetica', 14))
    ...
    def show_all_context(self):
        ...
        new_window.geometry('500x600')
        label = Label(new_window, text="Context sentences:", bg='white', font=('Helvetica', 15, 'bold'))
        label.grid(row=0, column=0, sticky='nswe')
        textbox = Text(new_window, bg='white', fg='black', font=('Helvetica', 14))
